...
DATA_DIR="/datanfs3/chenrongyi/codes/SkyRL/dataset/r2e-all"
...
# SP_SIZE=2
# TP_SIZE=2
export HF_HOME="/datanfs4/chenrongyi/hf"
export CUDA_VISIBLE_DEVICES=0
 uv run --active --frozen --extra verl --env-file .env -m skyrl_agent.integrations.verl.verl_main_ppo \
    ...
    trainer.save_freq=1 \
    trainer.default_local_dir=/datanfs3/chenrongyi/codes/SkyRL/verl_grpo_skyagent/skyagent-verl-30b-r2e-4500-loop-sep27 \
    trainer.test_freq=20 \
    trainer.total_epochs=15 \
    trainer.rollout_data_dir=/datanfs3/chenrongyi/codes/SkyRL/verl_grpo_skyagent/qwen2.5_1.5b_function_rm \
    trainer.validation_data_dir=/datanfs3/chenrongyi/codes/SkyRL/verl_grpo_skyagent/qwen2.5_1.5b_function_rm_val \
